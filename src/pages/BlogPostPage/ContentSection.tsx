...
import { BlogPostForPage } from "../../types/entities"
...
const ContentSection: React.FC<Props> = ({ post }) => {
    const content = post.preview + post.body

    return (
        <>
            <section className="bg-neutral w-full flex flex-col gap-9 md:gap-8 text-secondary px-4 sm:px-18 lg:px-37 xl:px-90">
                <div className="w-full flex flex-col gap-3 md:gap-5" dangerouslySetInnerHTML={{ __html: content }}>
