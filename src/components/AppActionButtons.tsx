...
export const PlayStoreButton: React.FC<Props> = ({to}) => {
    ...
    return <Link to={to} className="btn btn-secondary w-50 flex flex-row justify-between text-neutral rounded-full py-6.5 transition-all ease-in-out duration-300 hover:scale-105">
